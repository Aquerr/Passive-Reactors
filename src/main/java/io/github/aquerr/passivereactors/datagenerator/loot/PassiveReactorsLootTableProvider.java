...
public class PassiveReactorsLootTableProvider extends LootTableProvider
{
    ...
    public PassiveReactorsLootTableProvider(DataGenerator dataGenerator)
    {
        super(dataGenerator);
    }
    ...
    {
        return "PassiveReactorsLootTableProvider";
    }
